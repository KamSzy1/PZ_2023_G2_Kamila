...
insert into login values (1,1,"token","email","207023ccb44feb4d7dadca005ce29a64");
insert into login values (2,2,"token1","email1","6d932c406fa15164ee48ff5a52f81dae");
insert into login values (3,3,"token2","email2","ed71c5d55af657bc2413020e5580d4dd");
insert into login values (4,4,"token3","email3","daa9bda719032ae88abadb9cda4aa846");
insert into login values (5,5,"token4","email4","4bc0550cd0afc7bbe97be48a36303f6e");

insert into users values (1,"Patryk","Wyczawski","Urzednicza 2/9","32-032","Poznań","123456789",3,1,1);
insert into users values (2,"Kamila","Szydełko","Warszawska 2","31-111","Kraków","123123123",1,2,2);
insert into users values (3,"Kacper","Dziuba","Podwisłocze 31","11-111","Rzeszów","321321321",3,3,3);
insert into users values (4,"Lidia","Pacyna","Lwowska 307","21-021","Radom","123459876",2,4,2);
insert into users values (5,"Weronika","Nowacka","Mieszka 1","11-111","Rzeszów","987654321",2,5,1);
